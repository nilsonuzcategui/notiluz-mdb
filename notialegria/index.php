...
<head>
    ...
    $descriptionAux = 'Observa esta labor social que estamos haciendo en nuestra Venezuela, Tú puedes ser parte de esta visión dejando un aporte para ayudar a otros.';
    ?>
    <meta charset="UTF-8" />
                            ...
                            <div id="carruselNotiAlegria" class="carousel slide carousel-fade ms-3" data-mdb-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item active">
                                        <img src="<?= $ruta_inicio ?>/img/notialegria/foto1.png" class="d-block" />
                                    </div>

                                    <div class="carousel-item">
                                        <img src="<?= $ruta_inicio ?>/img/notialegria/foto2.png" class="d-block" />
                                    </div>

                                    <div class="carousel-item">
                                        <img src="<?= $ruta_inicio ?>/img/notialegria/foto3.png" class="d-block" />
                                    </div>

                                    <div class="carousel-item">
                                        <img src="<?= $ruta_inicio ?>/img/notialegria/foto4.png" class="d-block" />
                                    </div>

                                    <div class="carousel-item">
                                        <img src="<?= $ruta_inicio ?>/img/notialegria/foto5.jpg" class="d-block" />
                                    </div>
